...
<body>
    ...
    <!-- end nav -->
    <!-- hot product -->
    <section id="popular-product" class="hot-product">
        <!-- heading -->
        <div class="product-heading">
            <h3>Sản phẩm Phổ Biến</h3>
            <a href="">Đây là tất cả sản phẩm phổ biến nhiều người mua nhất</a>
        </div>
        <!-- container -->
        <div class="popular-container">
            ...
            <div class="p-product-box">
                <!-- img -->
                <a href="product-page.php" class="p-product-img">
                    <img src="../img/p3.png" alt="">
                </a>
                <!-- text -->
                <div class="p-product-text">
                    <!-- title -->
                    <a href="product-page.php" class="product-name">
                        Computer HP
                    </a>
                    <!-- category -->
                    <span class="category">
