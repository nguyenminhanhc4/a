...
<body>
    ...
    <nav class="navigation">
        ...
        <ul class="menu">
            ...
            <li><a href="home.php#popular-product">Phổ biến nhất</a></li>
        ...
        <div class="nav-btns">
            ...
            <!-- user -->
            <a href="user.php" class="nav-user">
    ...
    <section id="product-details">
        ...
        <div class="d-product-text">
            <!-- category -->
            <span class="category">Đồ điện tử > Máy tính cá nhân</span>
            <!-- title -->
            <strong>Máy Tính Tốt Nhất Để Chơi Pikachu</strong>
            <!-- rating -->
            <span class="rating">
            ...
            <!-- detail -->
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquid qui laudantium eligendi fugit
                perspiciatis dicta quos dolorum error minus optio saepe omnis at nisi laborum labore repellendus,
                esciunt quo odit?</p>
            <!--price  -->
